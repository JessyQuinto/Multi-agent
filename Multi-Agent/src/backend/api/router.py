...
from common.services.plan_service import PlanService
from common.services.team_service import TeamService
...
async def init_team(
    ...
    # For now I will set the initial install team id as 00000000-0000-0000-0000-000000000001 (HR Service Desk),
