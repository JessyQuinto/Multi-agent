...
from config.settings import connection_config, orchestration_config
from models.messages import (UserClarificationRequest,
...
class ProxyAgent(Agent):
    ...
    async def _wait_for_user_clarification(
        ...
        try:
            ...
            from models.messages import TimeoutNotification, WebsocketMessageType
