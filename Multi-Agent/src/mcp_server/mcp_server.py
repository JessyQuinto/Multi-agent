...
# Initialize services
factory.register_service(PolicyService())
factory.register_service(TicketService())
factory.register_service(CertificatesService())
factory.register_service(PayrollService())
factory.register_service(BenefitsService())
factory.register_service(TimeOffService())
