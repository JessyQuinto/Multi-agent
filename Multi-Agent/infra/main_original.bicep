...
param gptReasoningModelName string = 'gpt-4o-mini'

@description('Optional. Version of the GPT Reasoning model to deploy. Defaults to 2025-04-14.')
param gptReasoningModelVersion string = '2024-07-18'
    ...
    deployments: [
      {
        ...
        model: {
          ...
          name: aiFoundryAiServicesModelDeployment.modelName
      ...
      }
      {
        ...
        model: {
          ...
          name: aiFoundryAiServices4_1ModelDeployment.modelName
      ...
      }
      {
        ...
        model: {
          ...
          name: aiFoundryAiServicesReasoningModelDeployment.modelName
