...
@metadata({
  azd: {
    type: 'location'
    usageName: [
      'OpenAI.Standard.gpt-4o-mini, 10'
      'OpenAI.Standard.gpt-35-turbo, 10'
    ]
  }
})
...
param gptReasoningModelName string = 'gpt-35-turbo'

@minLength(1)
@description('Optional. Name of the GPT model to deploy:')
param gpt4_1ModelName string = 'gpt-4o-mini'

@description('Optional. Version of the GPT model to deploy. Defaults to 2024-07-18.')
param gpt4_1ModelVersion string = '2024-07-18'

@description('Optional. Version of the GPT Reasoning model to deploy. Defaults to 0125.')
param gptReasoningModelVersion string = '0125'
...
@description('Optional. GPT model deployment type. Defaults to Standard.')
param gpt4_1ModelDeploymentType string = 'Standard'
...
@description('Optional. GPT model deployment type. Defaults to Standard.')
param gptReasoningModelDeploymentType string = 'Standard'
...
@description('Optional. AI model deployment token capacity. Defaults to 10 for optimal performance.')
param gpt4_1ModelCapacity int = 10
